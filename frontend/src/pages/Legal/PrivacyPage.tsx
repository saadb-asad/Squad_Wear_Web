    ...
    <main className="w-full max-w-max-width mx-auto px-4 lg:px-margin-desktop space-y-12 py-12">
      <div className="border border-outline p-6 lg:p-10 bg-surface space-y-8 animate-fade-in">
        <div className="space-y-4">
          <h1 className="font-display text-shout text-display-lg text-on-surface">Privacy Policy</h1>
        ...
        <div className="space-y-8">
          <div className="border border-outline p-6 lg:p-8 bg-surface-container-low space-y-4">
            <h2 className="font-display text-shout text-display-md text-on-surface">1. Information We Collect</h2>
          ...
          <div className="border border-outline p-6 lg:p-8 bg-surface-container-low space-y-4">
            <h2 className="font-display text-shout text-display-md text-on-surface">2. How We Use Your Information</h2>
            <p className="text-on-surface-variant font-body-md text-body-md">
          ...
          <div className="border border-outline p-6 lg:p-8 bg-surface-container-low space-y-4">
            <h2 className="font-display text-shout text-display-md text-on-surface">3. Protection of Your Information</h2>
            <p className="text-on-surface-variant font-body-md text-body-md">
          ...
          <div className="border border-outline p-6 lg:p-8 bg-surface-container-low space-y-4">
            <h2 className="font-display text-shout text-display-md text-on-surface">4. Disclosure of Information to Outside Parties</h2>
            <p className="text-on-surface-variant font-body-md text-body-md">
          ...
          <div className="border border-outline p-6 lg:p-8 bg-surface-container-low space-y-4">
            <h2 className="font-display text-shout text-display-md text-on-surface">5. Contacting Us</h2>
            <p className="text-on-surface-variant font-body-md text-body-md">
