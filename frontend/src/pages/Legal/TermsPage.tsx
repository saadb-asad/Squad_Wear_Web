    ...
    <main className="w-full max-w-max-width mx-auto px-4 lg:px-margin-desktop space-y-12 py-12">
      <div className="neo-extruded p-6 lg:p-10 rounded-[40px] bg-surface space-y-8 animate-fade-in">
        <div className="space-y-4">
          <h1 className="font-headline-xl text-headline-xl text-on-surface">Terms and Conditions</h1>
        ...
        <div className="space-y-8">
          ...
          <div className="neo-recessed rounded-3xl p-6 lg:p-8 bg-surface-container-low space-y-4">
            <h2 className="font-headline-md text-headline-md text-on-surface">2. Products and Pricing</h2>
            <p className="text-on-surface-variant font-body-md text-body-md">
          ...
          <div className="neo-recessed rounded-3xl p-6 lg:p-8 bg-surface-container-low space-y-4">
            <h2 className="font-headline-md text-headline-md text-on-surface">3. Payment Terms</h2>
            <p className="text-on-surface-variant font-body-md text-body-md">
          ...
          <div className="neo-recessed rounded-3xl p-6 lg:p-8 bg-surface-container-low space-y-4">
            <h2 className="font-headline-md text-headline-md text-on-surface">4. Intellectual Property</h2>
            <p className="text-on-surface-variant font-body-md text-body-md">
          ...
          <div className="neo-recessed rounded-3xl p-6 lg:p-8 bg-surface-container-low space-y-4">
            <h2 className="font-headline-md text-headline-md text-on-surface">5. Contact Information</h2>
            <p className="text-on-surface-variant font-body-md text-body-md">
